...
class ClassOptionController(Resource):
    ...
    def get(self):
        ...
        class_options = ClassOption.find().all()
    ...
    def put(self, pk):
        ...
        class_option.location = args['location']
        class_option.day_of_week = args['day_of_week']
        class_option.start_time = start_time
        class_option.end_time = end_time
        class_option.terms = term_list
        class_option.level = args['level']
